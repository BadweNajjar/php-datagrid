...
/**
 * PHP DataGrid :: Sample #1-2 (code)
 *
 * Auto-generated CI4 controller wrapper around examples/code_1_2_example.php.
 * Drop into app/Controllers/Examples/ and route to it.
 */
class Code12Example extends BaseController
{
...
<html>
  <head>
    ...
    <meta name='description' content='PHP DataGrid - using PHP DataGrid for displaying some statistical data, with aggregation function' />
...
<?php
    ...
    if(($mode == "edit") || ($mode == "details")){
        ...
        ##  *** put a primary key on the first place
		  ...
		  $default_order = array("id"=>"DESC");
          $dgrid1->DataSource($db, $sql, $default_order);
