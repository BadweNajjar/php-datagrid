...
/**
 * SqlParser — simple SQL tokenizer / parser.
 *
 * Used internally by DataGrid to introspect SELECT statements (split FROM,
 * WHERE, ORDER BY clauses) so the grid can re-emit them with paging,
 * sorting and filtering applied. Does NOT support multi-line comments.
 *
 * @package DataGrid
 ...
 *
 * Patch history:
 *  - 2017-05-05: replaced !isset() with empty() to prevent PHP 7.1
 *                "Illegal string offset" warnings.
 *  - 2017-05-05: $handle made a private data member.
