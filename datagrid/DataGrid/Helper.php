 ...
 * PHP DataGrid — Helper.
 *
 * Stateless static utilities used throughout the DataGrid class:
 * random-string generation, browser detection, language vocabulary lookup,
 * case conversion, color name/value mapping, file-upload error reporting
